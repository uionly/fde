    ...
    <aside aria-label="Featured AI Labs incident" className="self-center overflow-hidden rounded-xl border border-background/15 bg-background/[0.06]">
      <div className="border-b border-background/15 p-5 sm:p-6">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <p className="font-mono text-[10px] font-semibold uppercase tracking-[0.14em] text-inverse-primary">{customerName} / Live incident</p>
          <span className="inline-flex items-center gap-1.5 rounded-full border border-background/15 px-2.5 py-1 font-mono text-[9px] font-semibold uppercase tracking-[0.1em] text-background/55">
            <Clock3 aria-hidden="true" className="size-3 text-inverse-primary" />
      ...
      <div className="p-5 sm:p-6">
        <div className="flex items-start gap-3">
          <Target aria-hidden="true" className="mt-0.5 size-4 shrink-0 text-inverse-primary" />
          <div>
            <p className="font-mono text-[9px] font-semibold uppercase tracking-[0.12em] text-background/55">Your objective</p>
        ...
        <div className="mt-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <p className="flex items-center gap-2 text-xs text-background/50">
            {attempted ? <CheckCircle2 aria-hidden="true" className="size-3.5 text-emerald-400" /> : <span aria-hidden="true" className="size-1.5 rounded-full bg-inverse-primary" />}
